...
* 最终的结论：
*       放到TreeSet或者TreeMap集合key部分的元素要想做到排序，包括2种方式：
...
public class TreeSetTest02 {
    public static void main(String[] args) {
        ...
        //TreeSet<WuGui> treeSet = new TreeSet<>();这样不行，没有通过构造方法传递一个比较器。
        ...
        treeSet.add(new WuGui(800));
        treeSet.add(new WuGui(100));
        treeSet.add(new WuGui(104));
        treeSet.add(new WuGui(15320));
        for (WuGui data: treeSet
             ) {
